...
<div class="row full section-size"style="max-width: 113.5rem !important">
  ...
  <div class="tabla">
    <h1 style="color: white;font-size: 33px;font-weight: lighter;">categorías</h1><table border="1">
       
        <h1 style="font-size: 33px;font-weight: lighter;"><a href="{{url('createCategory')}}" style="color:white;text-decoration: none;float: left;">añadir categoría</a></h1>

        <table border="1">  
      <tbody>
        <tr class="nohover">
          <td class="sinborderleft" width="5%">categoria ID</td>
...
<?php foreach ($categories as $cat) {
      ?>
        <tr class="nohover">
        	<td class="sinborderleft " >{{$cat->id}}</td>
          <td class="sinborderleft " >{{$cat->category_name}}</td>
