...
<div class="row full section-size"style="max-width: 113.5rem !important">
  ...
  <div class="tabla">
    <h1 style="color: white;font-size: 33px;font-weight: lighter;">subcategorías</h1><table border="1">
       
        <h1 style="font-size: 33px;font-weight: lighter;"><a href="{{url('createsubCategory')}}" style="color:white;text-decoration: none;float: left;">añadir subcategoría</a></h1>

        <table border="1">  
      <tbody>
        <tr class="nohover">
          <td class="sinborderleft" width="5%">identificación de subcategoría</td>
          <td class="sinborderleft" width="5%">categoría principal</td>
          <td width="15%">nombre de la subcategoría </td>
